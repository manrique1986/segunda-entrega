<template>
  ...
  <div id="formContent">
    ...
    <div class="fadeIn first">
      <img class="logo" src="https://res.cloudinary.com/dytpump6i/image/upload/v1659467766/images_erdvl1.jpg" id="icon" alt="" />
    </div>

    <!-- Login Form -->
    <form>
      <input v-model="usuario" type="text" id="login" class="fadeIn second" name="login" placeholder="usuario">
